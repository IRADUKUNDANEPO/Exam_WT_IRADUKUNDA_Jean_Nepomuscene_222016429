...
<head>
  ...
  <title> Retrieve Our Document's Metadata</title>
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Detail information Of Metadata</title>
    <style>
        table {
            width: 100%;
...
<body>
    <center><h2>Table of Metadata</h2></center>
    <table border="5">
        <tr>
            <th>Metadata ID</th>
            <th>Creation Date</th>
        ...
        // Prepare SQL query to retrieve all metadata
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $metadataId = $row['MetadataID']; // Fetch the MetadataID
                echo "<tr>
                    <td>" . $row['MetadataID'] . "</td>
                    <td>" . $row['CreationDate'] . "</td>
                    <td>" . $row['LastModifiedDate'] . "</td>
                    <td><a style='padding:4px' href='delete_metadata.php?MetadataID=$metadataId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_metadata.php?MetadataID=$metadataId'>Update</a></td> 
                </tr>";
            }
        } else {
