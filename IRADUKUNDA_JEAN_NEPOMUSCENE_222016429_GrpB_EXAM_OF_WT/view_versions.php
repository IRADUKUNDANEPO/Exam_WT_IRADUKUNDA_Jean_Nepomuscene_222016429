...
<head>
  ...
  <title> Retrieve Versions of our Documents</title>
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Detail Information of Versions</title>
    <style>
        table {
            width: 100%;
...
<body>
    <center><h2>Table of Versions</h2></center>
    <table border="5">
        <tr>
            <th>Version ID</th>
            <th>Document ID</th>
        ...
        // Prepare SQL query to retrieve all versions
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $versionId = $row['VersionID']; // Fetch the VersionID
                echo "<tr>
                    <td>" . $row['VersionID'] . "</td>
                    ...
                    <td>" . $row['CreatedAt'] . "</td>
                    <td><a style='padding:4px' href='delete_versions.php?VersionID=$versionId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_versions.php?VersionID=$versionId'>Update</a></td> 
                </tr>";
            }
        } else {
