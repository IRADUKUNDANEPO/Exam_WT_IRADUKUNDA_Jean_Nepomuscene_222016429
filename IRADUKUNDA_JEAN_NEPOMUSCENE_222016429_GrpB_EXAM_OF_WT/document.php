...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <input type="number" id="metadataId" name="metadataId" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO Documents(DocumentID, Title, Content, AuthorID, CategoryID, MetadataID, CreatedAt) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("issssss", $docId, $title, $content, $authorId, $categoryId, $metadataId, $createdAt);
