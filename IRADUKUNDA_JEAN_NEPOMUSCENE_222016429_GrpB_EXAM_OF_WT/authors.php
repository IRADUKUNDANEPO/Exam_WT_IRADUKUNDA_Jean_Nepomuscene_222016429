...
<head>
  ...
  <title>Our Authors of our Documents</title>
...
<section>
   ...
   <!-- Author Form for insertion into the Authors table -->
<h1><u>Author Form</u></h1>
...
<!-- PHP code for inserting data into the Authors table -->
<?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO Authors(AuthorID, Name, Email, Gender) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("isss", $authorId, $name, $email, $gender);
