...
<head>
  ...
  <title> Retrieve Our Authors of our Documents</title>
...
<body>
    ...
    <table border="5">
       ...
       include('Database_Connection.php');
        ...
        // Prepare SQL query to retrieve all authors
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $authorId = $row['AuthorID']; // Fetch the AuthorID
                echo "<tr>
                    <td>" . $row['AuthorID'] . "</td>
                    <td>" . $row['Name'] . "</td>
                    <td>" . $row['Email'] . "</td>
                    <td>" . $row['Gender'] . "</td>
                    <td><a style='padding:4px' href='delete_authors.php?AuthorID=$authorId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_authors.php?AuthorID=$authorId'>Update</a></td> 
                </tr>";
            }
        } else {
