...
<head>
  ...
  <title> Retrieve Categories of our Documents</title>
       ...
       include('Database_Connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $categoryId = $row['CategoryID']; // Fetch the CategoryID
                echo "<tr>
                    <td>" . $row['CategoryID'] . "</td>
                    <td>" . $row['CategoryName'] . "</td>
                    <td><a style='padding:4px' href='delete_categories.php?CategoryID=$categoryId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_categories.php?CategoryID=$categoryId'>Update</a></td> 
                </tr>";
            }
        } else {
