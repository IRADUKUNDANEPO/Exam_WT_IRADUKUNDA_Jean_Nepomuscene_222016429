...
<head>
  ...
  <title> Retrieve our Documents</title>
...
<body>
    <center><h2>Table of Documents</h2></center>
    <table border="5">
        <tr>
            <th>Document ID</th>
            <th>Title</th>
       ...
       include('Database_Connection.php');
        ...
        // Prepare SQL query to retrieve all documents
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $docId = $row['DocumentID']; // Fetch the DocumentID
                echo "<tr>
                    ...
                    <td>" . $row['CreatedAt'] . "</td>
                    <td><a style='padding:4px' href='delete_document.php?DocumentID=$docId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_document.php?DocumentID=$docId'>Update</a></td> 
                </tr>";
            }
        } else {
