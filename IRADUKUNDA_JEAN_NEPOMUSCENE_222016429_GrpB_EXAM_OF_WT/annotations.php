...
<head>
  ...
  <title>Annotations for our Documents</title>
...
<!-- Annotation Form for insertion into the Annotations table -->
<h1><u>Annotation Form</u></h1>
<form method="post" onsubmit="return confirmInsert();">
        
    <label for="annotationId">Annotation ID:</label>
    <input type="number" id="annotationId" name="annotationId"><br><br>
    ...
    <input type="date" id="annotationDate" name="annotationDate" required><br><br>

    <input type="submit" name="add" value="Insert">
   
</form>

<!-- PHP code for inserting data into the Annotations table -->
<?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO Annotations(AnnotationID, DocumentID, PageNumber, Text, AuthorID, AnnotationDate) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("iisiss", $annotationId, $docId, $pageNumber, $text, $authorId, $annotationDate);
