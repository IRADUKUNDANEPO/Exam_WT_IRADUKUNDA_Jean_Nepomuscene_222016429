...
<section>
    ...
    <!-- Tags form for insertion into the Tags table -->
<h1><u>Tags Form</u></h1>
...
<!-- PHP code for inserting data into the Tags table -->
<?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO Tags(TagID, TagName) VALUES (?, ?)");
