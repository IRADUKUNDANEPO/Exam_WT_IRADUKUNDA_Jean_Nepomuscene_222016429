...
<head>
  ...
  <title>Categories of our Documents</title>
...
<section>
   ...
   <!-- Category form for insertion into the Category table -->
...
<!-- PHP code for inserting data into the Categories table -->
<?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO Categories(CategoryID, CategoryName) VALUES (?, ?)");
