...
<head>
  ...
  <title> Retrieve the Access Logs to our Documents</title>
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Detail information Of Access Logs</title>
    <style>
        table {
            width: 100%;
...
<body>
    <center><h2>Table of Access Logs</h2></center>
    <table border="5">
        <tr>
            <th>Log ID</th>
            <th>Document ID</th>
       ...
       include('Database_Connection.php');
        ...
        // Prepare SQL query to retrieve all access logs
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $logId = $row['LogID']; // Fetch the LogID
                echo "<tr>
                    <td>" . $row['LogID'] . "</td>
                    ...
                    <td><a style='padding:4px' href='delete_accesslogs.php?LogID=$logId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_accesslogs.php?LogID=$logId'>Update</a></td> 
                </tr>";
            }
        } else {
