...
<head>
  ...
  <title> Retrieve Annotations for our Documents</title>
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Detail information Of Annotations</title>
    <style>
        table {
            width: 100%;
...
<body>
    <center><h2>Table of Annotations</h2></center>
    <table border="5">
        <tr>
            <th>Annotation ID</th>
            <th>Document ID</th>
       ...
       include('Database_Connection.php');
        ...
        // Prepare SQL query to retrieve all annotations
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $annotationId = $row['AnnotationID']; // Fetch the AnnotationID
                echo "<tr>
                    ...
                    <td><a style='padding:4px' href='delete_annotations.php?AnnotationID=$annotationId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_annotations.php?AnnotationID=$annotationId'>Update</a></td> 
                </tr>";
            }
        } else {
