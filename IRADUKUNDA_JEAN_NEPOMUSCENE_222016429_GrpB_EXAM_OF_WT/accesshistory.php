...
<head>
  ...
  <title>History of Access the Documents</title>
...
<!-- Access History Form -->
<h1><u>Access History Form</u></h1>
<form method="post" onsubmit="return confirmInsert();">
        
    <label for="accessHistoryId">Access History ID:</label>
    <input type="number" id="accessHistoryId" name="accessHistoryId"><br><br>
    ...
    <input type="date" id="accessDate" name="accessDate" required><br><br>

    <input type="submit" name="add" value="Insert">
   
</form>

<!-- PHP code for inserting data into the AccessHistory table -->
<?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO AccessHistory(AccessHistoryID, DocumentID, UserID, AccessDate) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("iiis", $accessHistoryId, $docId, $userId, $accessDate);
    // Set parameters and execute
    $accessHistoryId = $_POST['accessHistoryId'];
    $docId = $_POST['docId'];
    $userId = $_POST['userId'];
