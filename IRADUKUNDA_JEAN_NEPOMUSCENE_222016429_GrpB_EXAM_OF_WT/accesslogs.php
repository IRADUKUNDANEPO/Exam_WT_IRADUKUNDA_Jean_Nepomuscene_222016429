...
<head>
  ...
  <title>Access Logs to our Documents</title>
                            ...
                            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="view_document.php">Documents table</a></li>
                                            <li><a class="dropdown-item" href="view_category.php">Categories table</a></li>
                                            <li><a class="dropdown-item" href="view_tags.php">Tags table</a></li>
                                            <li><a class="dropdown-item" href="view_accesslogs.php">Access Logs table</a></li>
                                            <li><a class="dropdown-item" href="view_version.php">Versions table</a></li>
                                            <li><a class="dropdown-item" href="view_comment.php">Comments table</a></li>
                                            <li><a class="dropdown-item" href="view_author.php">Authors table</a></li>
                                            <li><a class="dropdown-item" href="view_metadata.php">Metadata table</a></li>
                                            <li><a class="dropdown-item" href="view_accesshistory.php">Access History table</a></li>
                                            <li><a class="dropdown-item" href="view_annotations.php">Annotations table</a></li>
                                        </ul>
...
<section>
   ...
   <!-- Access Log Form for insertion into the AccessLogs table -->
<h1><u>Access Log Form</u></h1>
<form method="post" onsubmit="return confirmInsert();">
        
    <label for="logId">Log ID:</label>
    <input type="number" id="logId" name="logId"><br><br>

    <label for="docId">Document ID:</label>
    <input type="number" id="docId" name="docId" required><br><br>

    <label for="userId">User ID:</label>
    <input type="number" id="userId" name="userId" required><br><br>

    <label for="accessTime">Access Time:</label>
    <input type="datetime-local" id="accessTime" name="accessTime" required><br><br>
...
<!-- PHP code for inserting data into the AccessLogs table -->
<?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO AccessLogs(LogID, DocumentID, UserID, AccessTime, AccessType) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("iiiss", $logId, $docId, $userId, $accessTime, $accessType);
