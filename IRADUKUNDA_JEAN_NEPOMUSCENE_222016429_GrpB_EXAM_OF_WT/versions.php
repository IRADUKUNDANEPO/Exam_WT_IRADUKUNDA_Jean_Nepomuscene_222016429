...
<head>
  ...
  <title>Versions of our Documents </title>
...
<section>
    ...
    <!-- Version form for inserting data into the Versions table -->
<h1><u> Version Form </u></h1>
<form method="post" onsubmit="return confirmInsert();">

    <label for="versId">Version ID:</label>
    <input type="number" id="versId" name="versId"><br><br>
        
    <label for="docId">Document ID:</label>
    <input type="number" id="docId" name="docId"><br><br>

    <label for="versionNumber">Version Number:</label>
    <input type="text" id="versionNumber" name="versionNumber" required><br><br>

    <label for="dateModified">Date Modified:</label>
    <input type="datetime-local" id="dateModified" name="dateModified" required><br><br>
...
<!-- PHP code for inserting data into the Versions table -->
<?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO Versions(VersionID, DocumentID, VersionNumber, DateModified, CreatedAt) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("iisss", $versId, $docId, $versionNumber, $dateModified, $createdAt);
